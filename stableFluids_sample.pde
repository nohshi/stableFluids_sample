...
float dt = 1.f/60; //微小時間Δt
float visc = 0.001; //粘性係数υ
float diff = 0.001; //inkの拡散係数
int max_gsIterate = 50; //反復法の最大反復数
float srcRad = 10; //速度やインク等を書き込む範囲の半径
float srcVelAmp = 0.1; //書き込む速度の大きさ
float srcInkAmp = 0.1; //書き込むインクの濃さ
